<template>
  <div class="relative">
    ...
    <div id="intro-section" class="h-screen p-4">
      <h1 class="font-solway font-bold text-3xl md:text-5xl text-center">
        <div>
          Find a cheap
          <br class="md:hidden" />
          electricity plan,
      ...
      <div class="w-full max-w-2xl mx-auto">
        ...
        >
          ...
          <template v-slot:answer>
            ...
            >
              <img
                src="~assets/img/usage-weight.png"
                class="absolute w-11/12 md:rounded-3xl md:shadow"
              />
            </div>
...
<script>
import SvgIntroBg from '@/assets/svg/intro-bg.svg'
import SvgIntroBgMobile from '@/assets/svg/intro-bg-mobile.svg'
import SvgPawprints from '@/assets/svg/pawprints.svg'
import SvgPawprintsMobile from '@/assets/svg/pawprints-mobile.svg'
import ViewPlans from '@/components/Landing/ViewPlans.vue'
import FaqsItem from '@/components/Landing/FaqsItem.vue'
