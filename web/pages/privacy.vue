<template>
  <div class="pt-20 md:pt-48 px-4 pb-8 md:pb-20">
    <div class="w-full max-w-2xl mx-auto">
      ...
      <p><i>Effective date: December 04, 2019</i></p>

      <p>
        Awesome Power ("us", "we", or "our") operates the
        https://awesomepowertexas.com website (hereinafter referred to as the
        "Service").
      </p>
      ...
      <ul>
        <li>
          ...
          <p>
            Service is the https://awesomepowertexas.com website operated by
            Awesome Power.
          </p>
        </li>
        <li>
      ...
      <h2>Use of Data</h2>
      <p>Awesome Power uses the collected data for various purposes:</p>
      <ul>
      ...
      <p>
        Awesome Power will take all the steps reasonably necessary to ensure
      ...
      <p>
        Awesome Power may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul>
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of Awesome Power</li>
        <li>
